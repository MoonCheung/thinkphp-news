        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-9 btn-group btn-crud">
                ...
                <a class="btn btn-primary" href="/tp_news/index.php/Admin/Auth/add_rule.html"><i class="icon-edit"></i>添加</a>
              </div>
              <div class="col-sm-3">
          ...
          <table class="table table-striped table-advance table-hover border-top">
            <thead class="tab-icon"><tr>
              ...
              <th class="lth"><i class="icon-user"></i>权限名称</th>
              <th class="lth"><i class="icon-user"></i>权限路由</th>
              <th><i class="icon-cogs"></i>操作</th>
            </tr></thead>
            <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                <td><input type="checkbox" value="<?php echo ($vo["id"]); ?>" name="select_item"></td>
                <td class="ltd"><?php echo ($vo['_name']); ?></td>
                <td class="ltd"><?php echo ($vo['name']); ?></td>
                <td>
                  <a class="btn btn-success btn-xs" href="/tp_news/index.php/Admin/Auth/add_childRule/id/<?php echo ($vo["id"]); ?>.html"><i class="icon-plus"></i></a>
                  <a class="btn btn-primary btn-xs" href="/tp_news/index.php/Admin/Auth/edit_rule/id/<?php echo ($vo["id"]); ?>.html"><i class="icon-pencil"></i></a>
  ...
  $(function(){
    $('.btn-close').on('click',function(){
      ...
      layer.confirm('您确定删除吗?', {
        ...
        ,yes: function(index){
          layer.close(index);
          window.location.href = "/tp_news/index.php/Admin/Auth/delete_rule/id/"+id;
        }
      });
    });
