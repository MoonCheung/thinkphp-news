...
<head>
  ...
  <link href="/tp_news/Public/Admin/bower_components/bootstrap-fileinput/css/fileinput.min.css" rel="stylesheet">
  <!-- 引入 plugin CSS的样式-->
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="label" class="col-sm-2 control-label">标题:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="title" placeholder="请输入标题">
                </div>
              </div>
              <div class="form-group">
                <label for="label" class="col-sm-2 control-label">标签:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="label" placeholder="请输入标签">
                </div>
              </div>
              <div class="form-group">
                <label for="picture" class="col-sm-2 control-label">附件:</label>
                <div class="col-sm-8 col-md-8 col-lg-6">
                  <input id="file" type="file" name="picture" class="input-file" multiple />
                </div>
              </div>
              <div class="form-group">
                <label for="desc" class="col-sm-2 control-label">描述:</label>
                <div class="col-sm-8 col-md-8 col-lg-6">
                  <textarea class="form-control input-text" cols="60" rows="5" name="desc" placeholder="请输入描述"></textarea>
                </div>
              </div>
              <div class="form-group">
