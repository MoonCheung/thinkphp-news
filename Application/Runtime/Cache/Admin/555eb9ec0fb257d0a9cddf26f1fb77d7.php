        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-9 btn-group btn-crud">
                ...
                <button type="button" class="btn btn-primary"><a href="/project/tp_boot/index.php/admin/new_sort/addNew"><i class="icon-edit"></i>添加</a></button>
              </div>
              <div class="col-sm-3">
          ...
          <table class="table table-striped table-advance table-hover border-top">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  <button class="btn btn-success btn-xs"><a href=""><i class="icon-ok"></i></a></button>
                  <button class="btn btn-primary btn-xs"><a href="/project/tp_boot/index.php/admin/new_sort/newEdit/id/<?php echo ($vo["id"]); ?>"><i class="icon-pencil"></i></a></button>
  ...
  $(function(){
    $('.btn-close').on('click',function(){
      ...
      layer.confirm('您确定删除吗?', {
        ...
        ,yes: function(index){
          layer.close(index);
          window.location.href = "/project/tp_boot/index.php/admin/new_sort/newDel/id/"+id;
        }
      });
    });
