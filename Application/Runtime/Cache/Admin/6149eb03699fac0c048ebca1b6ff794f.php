        ...
        <section class="panel">
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-9 btn-group btn-crud">
                <button type="button" class="btn btn-danger btn-all-del"><a href="javascript:;"><i class="icon-trash"></i>删除</a></button>
                <button type="button" class="btn btn-primary"><a href="/project/tp_boot/index.php/admin/new/add"><i class="icon-edit"></i>添加</a></button>
              </div>
              <div class="col-sm-3">
          ...
          <table class="table table-striped table-advance table-hover border-top">
            <thead class="tab-icon"><tr>
              ...
              <th><i class="icon-user"></i>性别</th>
              <th><i class="icon-user"></i>生日</th>
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><input type="checkbox" name="select_item" value="<?php echo ($vo["id"]); ?>"></td>
                ...
                <td>
                  <button class="btn btn-success btn-xs"><a href="javascript:;"><i class="icon-file-alt"></i></a></button>
                  <button class="btn btn-primary btn-xs"><a href="/project/tp_boot/index.php/admin/new/userEdit/id/<?php echo ($vo["id"]); ?>"><i class="icon-pencil"></i></a></button>
                  <button class="btn btn-danger btn-xs btn-close"><a href="javascript:;"><i class="icon-trash"></i></a></button>
                </td>
...
<script src="/project/tp_boot/Public/Admin/plugin/layer/layer.js"></script>
  ...
  $(function(){
    $('.btn-close').on('click',function(){
      ...
      layer.confirm('您确定删除吗?', {
        ...
        ,yes: function(index){
          layer.close(index);
          window.location.href = "/project/tp_boot/index.php/admin/new/userDel/id/"+id;
        }
      });
    });
