          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="title" value="<?php echo ($arti["title"]); ?>" placeholder="请输入文章标题">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <select name="cateid" class="form-control input-text">
                    ...
                    <?php if(is_array($cate)): $i = 0; $__LIST__ = $cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option <?php if($vo['id'] == $arti['cateid']): ?>selected="selected"<?php endif; ?> value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                  </select>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="author" value="<?php echo ($arti["author"]); ?>" placeholder="请输入作者">
                </div>
              </div>
              <div class="form-group">
                <label for="desc" class="col-sm-2 control-label">文章描述:</label>
                <div class="col-sm-8 col-md-7 col-lg-5">
                  <textarea class="form-control input-text" name="desc" cols="60" rows="5" placeholder="请输入描述"><?php echo ($arti["desc"]); ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label for="content" class="col-sm-2 control-label">文章内容:</label>
                <div class="col-sm-8">
                  <textarea id="editor" name="content"><?php echo ($arti["content"]); ?></textarea>
                </div>
              </div>
              <div class="form-group">
              ...
              <!--隐藏表单-->
              <input type="hidden" name="id" value="<?php echo ($arti["id"]); ?>">
            </form>
          </div>
        </div>
      </div>
