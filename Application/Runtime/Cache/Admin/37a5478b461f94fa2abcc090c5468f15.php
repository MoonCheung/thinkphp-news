          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-9 btn-group btn-crud">
                ...
                <a class="btn btn-primary" href="/tp_news/index.php/Admin/Carousel/addCar.html"><i class="icon-edit"></i>添加</a>
              </div>
              <div class="col-sm-3">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr><td><input type="checkbox" value="<?php echo ($vo["id"]); ?>" name="select_item"></td>
                ...
                <td>
                  <div class="col-sm-7 col-md-6 col-lg-4">
                    <a href="/tp_news/index.php/Admin/Carousel/download/id/<?php echo ($vo["id"]); ?>" class="thumbnail a-breviary" >
                ...
                <td>
                  <a class="btn btn-primary btn-xs" href="/tp_news/index.php/Admin/Carousel/carEdit/id/<?php echo ($vo["id"]); ?>.html"><i class="icon-pencil"></i></a>
  ...
  $(function(){
    $('.btn-close').on('click',function(){
      ...
      layer.confirm('您确定删除吗?', {
        ...
        ,yes: function(index){
          layer.close(index);
          window.location.href = "/tp_news/index.php/Admin/Carousel/cardel/id/"+id;
        }
      });
    });
