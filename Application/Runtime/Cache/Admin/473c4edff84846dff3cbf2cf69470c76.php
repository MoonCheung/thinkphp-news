          ...
          <div class="panel-body">
            <form class="form-horizontal" method="post" role="form">
              <div class="form-group">
                <label for="" class="col-sm-2 control-label">添加部门栏目:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="catename" value="<?php echo ($data["catename"]); ?>">
                </div>
              </div>
              <div class="form-group">
                <label for="" class="col-sm-2 control-label">所属部门:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="sort" value="<?php echo ($data["sort"]); ?>">
                </div>
              </div>
              <div class="form-group">
