      ...
      <div class="col-md-12">
        <div class="panel">
          ...
          <div class="panel-body">
            <form action="/project/tp_boot/index.php/Admin/Toplist/addArti" class="form-horizontal" method="post" role="form" enctype="multipart/form-data">
              <div class="form-group">
                <label for="title" class="col-sm-2 control-label">头条标题:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="title" placeholder="请输入头条标题">
                </div>
              </div>
              <div class="form-group">
                <label for="cateid" role="select" class="col-sm-2 control-label">头条栏目:</label>
                <div class="col-sm-3">
...
<script src="/project/tp_boot/Public/Admin/plugin/utf8-php/ueditor.config.js"></script>
<script src="/project/tp_boot/Public/Admin/plugin/utf8-php/ueditor.all.min.js"> </script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script src="/project/tp_boot/Public/Admin/plugin/utf8-php/lang/zh-cn/zh-cn.js"></script>
