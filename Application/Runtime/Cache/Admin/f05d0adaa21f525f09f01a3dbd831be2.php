            ...
            <form class="form-horizontal" role="form" method="post">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" class="form-control input-text" name="title" value="<?php echo ($data["title"]); ?>" placeholder="请输入权限名">
                </div>
              </div>
              <div class="form-group">
                <label for="name" class="col-sm-2 control-label">权限:</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control input-text" name="name" value="<?php echo ($data["name"]); ?>" placeholder="请输入权限">
