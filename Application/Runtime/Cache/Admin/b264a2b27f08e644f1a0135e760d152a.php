...
<section id="#main-content">
  <section class="wrapper">
    <ol class="breadcrumb">
      ...
      <li>栏目管理</li>
      <li class="active">部门栏目</li>
    </ol>
    <div class="row">
      <div class="col-md-12">
        <section class="panel">
          <div class="panel-heading">部门栏目</div>
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-9 btn-group btn-crud">
                <a class="btn btn-danger btn-all-del" href="javascript:;"><i class="icon-trash"></i>删除</a>
                <a class="btn btn-primary" href="/tp_news/index.php/Admin/DeptSort/addDept.html"><i class="icon-edit"></i>添加</a>
              </div>
              <div class="col-sm-3">
          ...
          <table class="table table-striped table-advance table-hover border-top">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  ...
                  <a class="btn btn-primary btn-xs" href="/tp_news/index.php/Admin/DeptSort/deptEdit/id/<?php echo ($vo["id"]); ?>.html"><i class="icon-pencil"></i></a>
  ...
  $(function(){
    $('.btn-close').on('click',function(){
      ...
      layer.confirm('您确定删除吗?', {
        ...
        ,yes: function(index){
          layer.close(index);
          window.location.href = "/tp_news/index.php/Admin/DeptSort/newDel/id/"+id;
        }
      });
    });
