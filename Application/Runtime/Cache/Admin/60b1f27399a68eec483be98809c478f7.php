          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-9 btn-group btn-crud">
                ...
                <a class="btn btn-primary" href="/project/tp_news/index.php/Admin/Rbac/addRole.html"><i class="icon-edit"></i>添加</a>
              </div>
              <div class="col-sm-3">
          ...
          <table class="table table-striped table-advance table-hover border-top">
            ...
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td>
                  ...
                  <a class="btn btn-primary btn-xs" href="/project/tp_news/index.php/Admin/Rbac/newEdit/id/<?php echo ($vo["id"]); ?>.html"><i class="icon-pencil"></i></a>
  ...
  $(function(){
    $('.btn-close').on('click',function(){
      ...
      layer.confirm('您确定删除吗?', {
        ...
        ,yes: function(index){
          layer.close(index);
          window.location.href = "/project/tp_news/index.php/Admin/Rbac/newDel/id/"+id;
        }
      });
    });
